...
class Variation {
    ...
    lateinit var date_on_sale_from: LocalDateTime
    lateinit var date_on_sale_from_gmt: LocalDateTime
    lateinit var date_on_sale_to: LocalDateTime
    lateinit var date_on_sale_to_gmt: LocalDateTime
