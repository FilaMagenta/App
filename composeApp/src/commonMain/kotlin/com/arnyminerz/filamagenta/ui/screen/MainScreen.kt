...
class MainScreen(
    private val isAddingNewAccount: Boolean = false,
    private val viewModel: MainViewModel = MainViewModel(),
    private val nfc: String? = null,
    private val onApplicationEndRequested: () -> Unit
): Screen {
    @Composable
    override fun Content() {
        ...
        when {
            error is WordpressException ->
                WordpressErrorDialog(error as WordpressException, viewModel::dismissError)
            error != null ->
                GenericErrorDialog(error as Throwable, viewModel::dismissError)
        }
